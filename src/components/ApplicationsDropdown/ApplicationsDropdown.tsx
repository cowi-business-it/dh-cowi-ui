...
const ApplicationsDropdown: React.FC<ApplicationsDropdownProps> = ({
  ...
  return (
    <DropdownMenuPrimitive.DropdownMenu onOpenChange={setIsOpen}>
      <DropdownMenuPrimitive.DropdownMenuTrigger className="flex items-center max-w-[220px] bg-white border border-gray-200 w-64 gap-2 p-3 focus:bg-gray focus:outline-none">
